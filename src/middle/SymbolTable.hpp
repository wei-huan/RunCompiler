...
struct FunctionEntry {
    ...
    void set_arg_list(vector<pair<string, VariableEntry>> list) { arg_list = list; }
...
struct FunctionTable {
    ...
    void register_func(string name, shared_ptr<FunctionEntry> entry) { ftable.insert({name, entry}); }
